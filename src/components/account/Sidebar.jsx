...
function Sidebar({ user, cookie }) {
    ...
    const links = [
        {
            title: language.account.account.title,
            link: '/account',
        ...
        {
            title: language.account.password.title,
            ...
            img: <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                ...
                <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
                    <path d="M3270 5109 c-537 -56 -1023 -398 -1267 -892 -124 -251 -169 -469
           -160 -769 8 -246 45 -407 145 -621 l46 -98 -976 -977 c-537 -537 -981 -987
           -987 -999 -16 -31 -14 -100 4 -137 9 -18 118 -134 243 -258 318 -316 307 -314
           544 -80 l148 146 208 -206 c295 -294 267 -296 594 30 125 124 234 240 243 258
           17 37 19 91 4 130 -5 16 -100 118 -209 229 l-200 201 513 511 512 511 90 -44
           c110 -53 246 -97 385 -126 83 -17 142 -21 285 -22 182 0 257 8 410 45 532 131
           963 534 1137 1063 134 409 97 859 -102 1245 -306 592 -939 929 -1610 860z
           m256 -809 c335 -35 603 -262 696 -587 32 -111 32 -305 0 -416 -81 -284 -296
           -495 -578 -567 -109 -29 -279 -29 -389 0 -358 92 -605 408 -605 775 0 225 87
           424 254 583 121 115 285 192 450 211 39 5 73 9 76 10 3 0 46 -4 96 -9z"/>
                </g>
            </svg>
        },
        {
